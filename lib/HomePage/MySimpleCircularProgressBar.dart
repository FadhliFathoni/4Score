...
class MySimpleCircularProgressBar extends StatefulWidget {
  ...
  const MySimpleCircularProgressBar({
    Key? key,
    this.size = 100,
    this.maxValue = 100,
    this.startAngle = 0,
  ...
  @override
  _MySimpleCircularProgressBarState createState() =>
      _MySimpleCircularProgressBarState();
}

class _MySimpleCircularProgressBarState
    extends State<MySimpleCircularProgressBar>
